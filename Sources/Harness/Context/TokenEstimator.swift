//
//  TokenEstimator.swift  (Harness)
//
//  Ported faithfully from AgentCore/Util/TokenEstimator.swift — no logic
//  changes. Rough char-based token estimator. Tokenisation differs per
//  model family (BPE vs SentencePiece vs different vocabularies), and
...
//
//  Used by the chat-header context-usage indicator and by the context
//  compactor (see ContextCompactor) to keep long agentic runs inside a
//  small local context window.
//
